...
The visual direction is a consistent slate workspace with mint actions, quieter surfaces, readable message text, restrained card borders, and clear navigation. Public discovery pages receive lighter typography and control refinements.
